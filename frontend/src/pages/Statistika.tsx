...
const Statistika = () => {
  ...
  let atrakcije = 0, restorani = 0, hoteli = 0, naslov = "";
  ...
  if (stateData) {
    ...
    hoteli = mesta.filter((m) => m.tip === 'hotel').length;
      ...
      <div className="bg-white shadow-2xl rounded-3xl p-8 border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="p-6 bg-yellow-50 rounded-2xl border-b-4 border-yellow-400 text-center">
            <span className="block text-sm font-bold text-yellow-600 uppercase">Restorani</span>
          ...
          <div className="p-6 bg-red-50 rounded-2xl border-b-4 border-red-400 text-center">
            <span className="block text-sm font-bold text-red-600 uppercase">Hoteli</span>
        ...
        <div className="bg-gray-50 rounded-3xl p-6 flex justify-center">
          {(atrakcije + restorani + hoteli) > 0 ? (
            ...
            <div className="py-20 text-center text-gray-400">
              <p className="text-lg italic">Nema dostupnih podataka za prikaz grafikona.</p>
            </div>
          )}
        </div>
